...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:right;" href="cart.php" class="btn btn-warning">Edit&nbsp;&nbsp;<img src="icons/edit.png" alt="" class="iconav"></a>
			<?php
			exit();
		}
	}
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo
						'<div class="row">
								<div class="col-md-2">
									<div class="btn-group">
										<a href="#" remove_id="'.$product_id.'" class="btn btn-danger remove"><img src="icons/trash.png" alt="" class="iconav"></a>
										<a href="#" update_id="'.$product_id.'" class="btn btn-primary update"><img src="icons/check.png" alt="" class="iconav"></a>
									</div>
								</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@Johnstore.com">
							...
							echo
								'<input type="hidden" name="return" value="http://localhost/My_Shop/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/My_Shop/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/My_Shop/cancel.php"/>
